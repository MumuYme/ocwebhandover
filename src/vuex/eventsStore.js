...
export default {
  ...
  state: {
    ...
    limitedEvent: {
      ...
      limitedEvent_0: {
        isDepartmentSession: true,
        eventType: "限定プログラム",
        title: "学科説明会",
        place: "2号館",
        info: "「どのようなことが学べるか？」など、学科の特徴を20分でお伝えします。東京千住キャンパスの各学科ごとに開催されていて、ここでは情報・通信・ネットーワーク分野を学べる3学科の情報を紹介します。※各回同じ内容を予定しています。",
      ...
      limitedEvent_1: {
        ...
        title: "学科説明会",
        subTitle: "情報メディア学科",
        faculty: "未来科学部", // 学科説明会が3学科全て同じ時間に開催につき追加
      ...
      limitedEvent_2: {
        ...
        title: "学科説明会",
        subTitle: "情報システム工学科",
        faculty: "システムデザイン工学部", // 学科説明会が3学科全て同じ時間に開催につき追加
        place: "2号館5階 2503",
        peopleNum: "252名",
        info: "「どのようなことが学べるか？」など、学科の特徴を20分でお伝えします。※各回同じ内容を予定しています。",
      ...
      limitedEvent_3: {
        ...
        title: "学科説明会",
        subTitle: "情報通信工学科",
        faculty: "工学部／工学部第二部", // 学科説明会が3学科全て同じ時間に開催につき追加
        place: "2号館6階 2601教室",
        peopleNum: "180名",
        info: "「どのようなことが学べるか？」など、学科の特徴を20分でお伝えします。※各回同じ内容を予定しています。",
