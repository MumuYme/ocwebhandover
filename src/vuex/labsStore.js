  ...
  state: {
    labo: {
      ...
      labo_4: {
        ...
        place: "1号館5階メディアラボ",
        info: "コンピュータと人々とのインタラクションを上手くデザインすることで、私たちの生活をより豊かにすることを目標に研究を行っています。CG、XR(VR/AR/MR)、AI、画像処理などのメディア情報処理に関わる幅広い分野で新時代を築く新しい技術やコンテンツの研究開発をしています。",
        theme: [
    ...
    labo_5: {
      ...
      labo_6: {
        ...
        place: "1号館4階演習室",
        info: "ヒトの心理や感性の特徴を観測し、データ解析の結果から科学的再現性がある法則を導き出して、機能性と感性的な満足感の向上を目指す感性工学をテーマとしています。特に、本研究室ではビデオゲームやWebサービスの動き、配色、デザイン、人口知能(AI)技術等について研究しています。",
        theme: [
      ...
      labo_7: {
        ...
        tags: ["音響工学", "VR", "AR","MR"],
        place: "1号館5階メディアラボ",
        info: "音は生活や文化にとって重要ですが、その理解や制御は簡単ではありません。そこで、MR(複合現実)技術や深層学習を用いた音場の分析・可視化や音のVR技術である音場合成技術、そしてそれらを支える音響計測技術等、音を良く知り、自由に創り出す技術の研究等を行っています。",
        theme: [
          "複合現実技術を用いた音場の可視化",
          "物理モデルを用いた音場計測と音場再現",
        ],
