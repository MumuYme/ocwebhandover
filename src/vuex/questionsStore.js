  ...
  state: {
    ...
    faq: {
      ...
      faq_2: {
        ...
        ans: "情報系の中でも、工学部情報通信工学科は「電波、光ファイバー、電子回路」といった通信部分に関わる科目が多く、未来科学部情報メディア学科は「3DCG、Webアプリケーション、情報セキュリティ」といった情報コンテンツの中身に関わる科目が多く、システムデザイン工学部情報システム工学科は「AI、機械学習、データサイエンス」といった解析技術に関わる科目が多く配当されています。情報メディア学科は、プログラミングでモノづくりを行う演習科目を重視している点が特色として挙げられます。履修可能な科目は下記リンク先をご参照ください。また、どのような講義であるか、感想などが気になる場合には是非本学の学生にお尋ねください。",
        links: [
          {
            name: "▶︎ カリキュラム（情報メディア学科公式サイト）",
            url: "https://www.im.dendai.ac.jp/curriculum/",
      ...
      faq_5: {
        ...
        ans: "必修の基礎科目として配当されているので、使います。詳細は大学案内をご確認下さい。また、必修のコンピュータプログラミングI/IIにおいて、高校までに習う「数学III」や「物理」の力学を使うほか、英語で書かれたエラーメッセージやマニュアル（ドキュメント）の読解を求められることがあります。",
        links: [],
      },
      ...
      faq_7: {
        ...
        ans: "東京電機大学の就職内定率は99.0%です。情報メディア学科の主な就職先の業種や割合、年度ごとの主な就職先は下記リンク先をご参照ください。研究室ごとの主な就職先は本ウェブサイトの｢研究室公開｣ページの研究室詳細をご参照ください。携わりたい職種がある場合には、是非下記情報をもとに研究室展示場所に赴き、どのようなことに取り組んでいたのか本学学生にお尋ねください。",
        links: [
          {
      ...
      faq_9: {
        ...
        ans: "2025年3月卒業実績における情報メディア学科の「ゲーム開発/インターネットサービス」業界への就職割合は約7%です。1年次必修科目の「コンピュータプログラミングI/II」の最終課題でProcessing（Java）を用いたゲーム作りを、4年次選択科目の「コンピュータアニメーションおよび演習」でUnity（C#）を用いた作品作りを行いますが、これらの経験のみでゲーム会社に就職することは難しいです。就職した学生の多くは、1年次から「ソフトウェア研究会」という部活に所属したり、3年次からゲームやCGに関連する研究室に所属して、チームでゲーム作りに取り組んだり、より専門的な知識や技術を身につけています。是非研究室展示場所に足を運び、どのようなことに取り組んできたのか学生に直接尋ねてみてください。",
        links: [
          {
            name: "▶︎ 就職実績（東京電機大学公式サイト）",
            url: "https://www.dendai.ac.jp/about/career/support/job.html",
