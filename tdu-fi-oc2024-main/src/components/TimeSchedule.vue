          ...
          <div class="py-4" id="timeline">
            ...
            <div style="display: flex">
              <v-timeline line-color="black" side="end">
                <v-timeline-item height="76px" size="xx-small">
              ...
              <div class="timeline-item pt-10 pl-1">
                <p>入場開始</p>
                <br />
                <p>&#xFE19;</p>
                        ...
                        >
                          ...
                          >
                            ...
                            <div>
                              ...
                              <template v-if="value.isTimeDisplay">
                                <p
                                  style="
                                    font-size: 0.7em;
                                    text-align: center;
                ...
                <p style="padding-top: 36px; padding-bottom: 20px">&#xFE19;</p>
                <p>オープンキャンパス終了</p>
              </div>
            </div>
          </div>
