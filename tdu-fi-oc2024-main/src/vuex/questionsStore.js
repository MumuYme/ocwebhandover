  ...
  state: {
    ...
    faq: {
      ...
      faq_9: {
        ...
        ans: "2022年3月卒業実績における情報メディア学科の「ゲーム開発/インターネットサービス」業界への就職割合は約5%です。1年次必修科目の「コンピュータプログラミングI/II」の最終課題でProcessing（Java）を用いたゲーム作りを、4年次選択科目の「コンピュータアニメーションおよび演習」でUnity（C#）を用いた作品作りを行いますが、これらの経験のみでゲーム会社に就職することは難しいです。就職した学生の多くは、1年次から「ソフトウェア研究会」という部活に所属したり、3年次からゲームやCGに関連する研究室に所属して、チームでゲーム作りに取り組んだり、より専門的な知識や技術を身につけています。是非研究室展示場所に足を運び、どのようなことに取り組んできたのか学生に直接尋ねてみてください。",
        links: [
          {
            name: "▶︎ 就職実績（東京電機大学公式サイト）",
            url: "https://www.dendai.ac.jp/about/career/support/job.html",
